               ...
               <tr>
                   <td colspan="3" class="between">
                     ...
                     <span>
                       ...
                       <a class="noa btn btn-outline-warning" id="submit" href="/User/Mypage/Resume/insert">수정</a>
                     </span>
                   </td>
               </tr>
               </thead>
...
<script>
   ...
   window.onload = function(){
	   let href="/User/Mypage/Resume/"+'${resume.resnum}';
	   fetch(href, {
           method: "GET"
       }).then(response => response.json())
       .then(map => {
       	let imgEl = document.querySelector('#picturePreview'); // 미리보기 이미지 요소
       	imgEl.src = map.resume.picture;
    ...
    document.getElementById('submit').addEventListener('click',function (){
      ...
      var skills ="";
        ...
        fetch("/User/Mypage/Resume/Insert",{
            method:"POST",
            headers: {
            ...
            body: JSON.stringify({
                ...
                uphone: document.getElementsByName("uphone")[0].value,
