...
<head>
  ...
  input[type="file"]{ max-width: 150px; }
  #picturePreview{
    max-height: 210px;
    margin: 0 auto;
  }
               ...
               <tr>
                   <td colspan="3" class="between">
                     ...
                     <span>
                       ...
                       <a class="noa btn btn-outline-warning" id="backup" href="/user/resume/backup">임시저장</a>
                       <a class="noa btn btn-outline-warning" id="backupList" href="/user/resume/backupList">불러오기</a>
                       <a class="noa btn btn-outline-warning" id="submit" href="/user/resume/insert">등록</a>
                     </span>
                   </td>
               </tr>
               </thead>
...
<script>
                    ...
                    fetch(a.href, {
                        ...
                        .then(json => {
                            ...
                            json.forEach(function (backup) {
                                output += '<li class="active"><a href="/user/resume/backup/' + backup.res_backnum + '">'
    ...
    document.querySelector("#fileInput").addEventListener('change',function(e){
    	...
    	if(file){
            ...
            reader.onload = function(e) {
                ...
                // 이미지의 src 속성을 선택된 파일의 데이터 URL로 설정
    ...
    document.getElementById('submit').addEventListener('click',function (){
      ...
      var skills ="";
          ...
          fetch("http://192.168.0.214:9090/User/Mypage/Resume/Insert", {
              method: "POST",
              body: formData
          }).then(res=>res.text())
        .then(write=>{
