...
<head>
    ...
    <style>
        ...
        .subtitle td:first-of-type{ background-color: #afe8bb; }
        ...
        <form action="/post/write" id="postWriteForm" method="POST">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a class="noa btn btn-success" id="list" href="/post">목록</a>
                        <a class="noa btn btn-success" id="backup" href="/post/backup">임시저장</a>
                        <a class="noa btn btn-success" id="backupList" href="/post/backupList">불러오기</a>
