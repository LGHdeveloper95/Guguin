...
<main>
    <div id="writeForm">
        ...
        <tr><td><span>연혁</span></td><td> <input type="text" name="history" value="${info.history}"/></td></tr>
        <tr><td><span>사원수</span></td><td> <input type="text" name="people_num" value="${info.people_num}"/></td></tr>
        <tr><td><span>홈페이지</span></td><td> <input type="text" name="link" value="${info.link}"/></td></tr>
        <tr><td><span>내용</span></td><td><textarea name="content" cols="60" rows="20">${info.content}</textarea></td></tr>
